...
public interface ServiceRepository extends CrudRepository<Service, Integer> {
    ...
    @Query(value="SELECT service FROM Service service WHERE service.serviceName LIKE CONCAT('%', :query, '%')")
    public List<Service> searchServices(@Param("query") String query);
